...
<style>
  ...
  * {{ box-sizing: border-box; }}
  ...
  .congestion-row summary {{
    display: grid;
    grid-template-columns: 1fr auto 64px 18px;
  ...
  .congestion-row summary::after {{
    content: '+'; color: var(--body-text); font-size: 16px; line-height: 1; text-align: right;
  }}
  ...
  .cr-badge {{ font-size: 13px; color: var(--body-text); white-space: nowrap; }}
  .cr-bed {{
